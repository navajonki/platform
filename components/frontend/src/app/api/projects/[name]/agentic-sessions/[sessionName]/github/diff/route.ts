...
export async function GET(
  ...
  const resp = await fetch(`${BACKEND_URL}/api/projects/${encodeURIComponent(name)}/agentic-sessions/${encodeURIComponent(sessionName)}/github/diff?${qs.toString()}`, { headers })
